...
When I chose this class, I was hoping to combine my love of writing with my interest in computers and code, and potentially my interest in videogames, as well. Though I've never been particularly adept at writing code, I hoped that studying digital writing would give me the tools I needed to be able to produced works akin to the text-based games and interactive stories that I'd heard of in the past. I didn't have much of a background in the topic, and it wasonly in the making of my first assignment, the case study, that I came to be aware of the Inform coding language, more specifically Inform 7. Upon finishing 'Everybody Dies' by Jim Munroe, I conducted some research into the engine that it was produced for, and stumbled across some documentation about Inform and how to make your own stories. Not knowing if I wanted to use it for my projects, I still chose to push through the initial learning curve and gained a simple understanding of the workings of the engine. Now being 5000 words deep into 'Directive', my first interactive story, I'm glad that I chose to undertake that research outside of the boundaries of the class. My final piece has come to resemble the types of works I was intitially interested in creating, which is something I'm personally quite happy with. 
